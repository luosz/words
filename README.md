...
top-notch
* adjective (informal) excellent; of the highest quality
...
fatigue
* noun [U] a feeling of being extremely tired, usually because of hard work or exercise
...
* (fatigues) [pl.] (especially AmE) duties, such as cleaning and cooking, that soldiers have to do, especially as a punishment

tell-tale
* adjective [only before noun] showing that sth exists or has happened
* noun (BrE) (AmE tattletale) (informal, disapproving) a child who tells an adult what another child has done wrong

segregate
* to separate one group of people from others, especially because they are of a different race, sex, or religion ≠ integrate segregate sb from sb
...
* to deliberately avoid discussing something or doing something = evade
...
accrue
* verb (formal) [V] ~ (to sb) (from sth) to increase over a period of time
* [VN] to allow a sum of money or debts to grow over a period of time
* Synonym: ACCUMULATE
...
alma mater
* sb's alma mater* the school, college etc that someone used to attend
* AmE the song of a particular school, college etc

vertebra
* noun (plural vertebrae ) any of the small bones that are connected together to form the SPINE
...
* noun (plural anatomies)
  * [U] the scientific study of the structure of human or animal bodies: the department of anatomy and physiology
  * [C, U] the structure of an animal or a plant: the anatomy of the horse ◆ human anatomy
  * [C] (humorous) a person's body: Various parts of his anatomy were clearly visible.
  * [C] (formal) an examination of what sth is like, the way it works or why it happens: an anatomy of the current recession
* anatomical adjective: anatomical diagrams
* anatomically adverb

embargo
* an official order to stop trade with another country = boycott, sanctions sanctions embargo on/against
...
go off
* [PHRASAL VERB] If you go off someone or something, you stop liking them. (BRIT INFORMAL)
* [PHRASAL VERB]  (EXPLODE) If an explosive device or a gun goes off, it explodes or fires.
* [PHRASAL VERB] (NOISE)If an alarm bell goes off, it makes a sudden loud noise.
* [PHRASAL VERB] (STOP WORKING) If an electrical device goes off, it stops operating.
* [PHRASAL VERB] (HAPPEN) If you say how an organized event went off, you are saying whether everything happened in the way that was planned or hoped.
* [PHRASAL VERB] (FOOD) Food or drink that has gone off has gone bad. (BRIT)
* phrasal verb UK (BECOME WORSE) to become worse in quality: That paper's really gone off since they got that new editor.
...
plunge
* verb
  * [+adv./prep.] to move or make sb/sth move suddenly forwards and/or downwards: [V] She lost her balance and plunged 100 feet to her death. ◆ The train left the track and plunged down the embankment. ◆ [VN] The earthquake plunged entire towns over the edge of the cliffs.
  * [V] (of prices, temperatures, etc.) to decrease suddenly and quickly

Sellotape
* (also sticky tape) (both BrE) (AmE Scotch tape) [U] clear plastic tape that is sticky on one side, used for sticking things together: a roll of Sellotape ◆ The envelope was stuck down with Sellotape.
...
heliport
* noun [C] a small airport for helicopters

pebble
* noun [C] a small smooth round stone, especially one found on a beach or in a river

prurient
* adjective (formal, disapproving) having or showing too much interest in things connected with sex

pachyderm
* noun (technical) a type of animal with a very thick skin, for example, an elephant
